   ...
   <div class="flex">
      ...
      <div class="icons">
         ...
         <?php
            ...
            $count_cart_items->execute(params: [$user_id]);
            $count_wishlist_items = $conn->prepare(query: "SELECT * FROM `wishlist` WHERE user_id = ?");
            $count_wishlist_items->execute(params: [$user_id]);
         ?>
